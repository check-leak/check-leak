...
#include "org_checkleak_core_CheckLeak.h"
...
JNIEXPORT void JNICALL Java_org_checkleak_core_CheckLeak_heapSnapshot
...
JNIEXPORT jobject JNICALL Java_org_checkleak_core_CheckLeak_getObjectField
